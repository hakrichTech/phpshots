...
<head>
    ...
    <div id="signin-div" class="topbar-section">
        ...
        <img id="signinimage" src="images/signinimage.png" class="">
    ...
    <div id="bell-div">
        ...
        <img id="wigglyline" src="images/wiggly-line.png">

        <img id="bell" src="images/Signin-bell.png">
    ...
    <div class="topbar-section topbar-menu">
        ...
        <img id="more-icon" src="images/more-icon.png">
    ...
    <div id="page-container">
        ...
        <div id="watch-listen">
            ...
            <div class="side-article">
                ...
                <p><a class="watch-listen-link" href="">Drone register gives 'accountability'</a></p>
